...
Production deployment happens after Olympia activation (Mordor block TBD; ETC mainnet block TBD). Production contracts require Cancun opcodes (MCOPY/EIP-5656) enabled by the Olympia fork itself.
